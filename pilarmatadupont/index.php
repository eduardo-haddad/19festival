...
$nome_artista = 'Pilar Mata Dupont';
    ...
    <main class="container" id="container">
        ...
        <div style="height:36px; clear: both">&nbsp;</div>
            ...
            <div class="row" >
                ...
                <?php pten('Artista contemplada com o <a href="/premios_e_residencias.php#premios" class="link">PRÊMIO DE RESIDÊNCIA WEXNER CENTER FOR THE ARTS</a> no Wexner Center for the Arts (Ohio, EUA)', 
                           'Artist awarded with the <a href="/premios_e_residencias.php#premios" class="link">WEXNER CENTER FOR THE ARTS residency prize</a> at Wexner Center for the Arts (Ohio, USA)'); ?>
                </span>
