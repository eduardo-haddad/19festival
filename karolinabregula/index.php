...
$urlplataforma = '#firefollowers';

include_once($_SERVER['DOCUMENT_ROOT'] . "/elements/config.php");

$pais_artista = $idioma == 'pt' ?  'Polônia' : 'Poland';
    ...
    <main class="container" id="container">
        ...
        <div style="height:36px; clear: both">&nbsp;</div>
            ...
            <div class="row" >
                ...
                <?php pten('Artista contemplada com o <a href="/premios_e_residencias.php#premios" class="link">PRÊMIO DE RESIDÊNCIA RES ARTIS</a> na Djerassi Resident Artists Program (Woodside, EUA)', 
                           'Artist awarded with the <a href="/premios_e_residencias.php#premios" class="link">RES ARTIS Residency Prize</a> at Djerassi Resident Artists Program (Woodside, USA)'); ?>
                </span>
