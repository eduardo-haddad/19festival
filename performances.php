        ...
        <!-- /HEADER -->
            ...
            <div class="row" style="clear: both; margin-bottom: 31px"><a name="fancy"></a>     
                <div class="col-sm-12 col-md-6 performance-servico relative" style="float: left ">
                    ...
                    *Em ocasião do lançamento da publicação <a href="publicacoes.php#festival" class="link"><em>Panoramas do Sul | Artistas selecionados – Obras e projetos</em></a></p>',
                    ...
                    21h30<br />
                    Sesc Pompeia | Convivência<br />
                    *Followed by the launch of the publication <a href="publicacoes.php#festival" class="link"><em>Southern Panoramas | Selected Works and Commissioned Projects</em></a></p>'); ?>
                </div>     
