        ...
        <div style="height:36px; clear: both">&nbsp;</div>
            ...
            <div class="row" id="obra">
                <div class="col-sm-12 col-md-6" style="text-align: center;" id="obra-img">
                    ...
                    <img src="../img/obras/obra_<?=strtolower(str_replace(' ', '', $nome_artista));?>_2.jpg" class="img-responsive" style="margin-bottom: 15px;" />
                </div>
                <div class="col-sm-12 col-md-6" id="obra-texto">
                    <div style="margin-bottom: 0" >
                        <span id="obra-titulo"><?php echo '<em>'; echo 'Wallpaper – Tangier</em> | '; print_r($obra['data_producao']); echo ', '; print_r ($idioma == 'pt' ? $obra['tipo_obra'] : $obra['tipo_obra_en']) ?><br /></span>
