...
<div class="row" style="clear: both;">   
            ...
            <div class="row" style="clear: both;">     
                ...
                <?php
                //Sobre residencia - PT
                pten('<p>O Djerassi Resident Artists Program tem como missão apoiar a produção artística oferecendo aos residentes tempo ininterrupto de trabalho, reflexão e interação com os demais artistas em um ambiente de reconhecida beleza natural. Maior programa de residência artística no oeste dos EUA, recebeu mais de 2.300 artistas em residência vindos de 51 países desde sua fundação, em 1979. </p>',

                //Sobre residencia - EN
                '<p>The mission of the Djerassi Resident Artists Program is to support art production by offering residents uninterrupted time to work, reflect and interact with other artists in a setting known for its scenic natural beauty. The leading artist residency program in the Western USA, it welcomed over 2,300 artists from 51 countries since its establishment, in 1979. </p>');  ?> 
                </div> 
            </div>
                            ...
                            <div class="col-sm-12 col-md-6" style="float: right; text-align: left">
                                <?php
                                    pten('<span class="bold">Res Artis</span><br />
                                          A Res Artis é uma associação composta por mais de 500 instituições, organizações e pessoas em mais de 70 países. Cada um dos seus membros se dedicada a oferecer a artistas, curadores e toda sorte de pessoas criativas o tempo necessário e o lugar distante das pressões e hábitos do dia a dia, uma experiência inserida dentro de um contexto geográfico e cultural único. Através da Res Artis, as organizações passam a fazer parte de uma comunidade global e se envolver em um diálogo que se realiza por meio de encontros presenciais ou virtuais.', 
                                         '<span class="bold">Res Artis</span><br />
                                          Res Artis is an association of over 500 centers, organisations, and individuals in over 70 countries. Each of its members is dedicated to offering artists, curators, and all manner of creative people the essential time and place away from the pressures and habits of every-day life, an experience framed within a unique geographic and cultural context. Through Res Artis, organisations will become part of a global community of colleagues engaged in dialogue through face-to-face meetings and virtually through online presence.'
                                         );
                                ?>
