...
<div class="row" style="clear: both;">   
    ...
    <?php
    //Sobre - PT
    pten('<p>O 19º Festival de Arte Contemporânea Sesc_Videobrasil oferece um Grande Prêmio a um dos artistas selecionados pelo edital de obras desta edição, escolhido pelo <a class="link" onclick="location.href = \'http://19festival.com/premios_e_residencias.php#juri\';">Júri de Premiação</a>. </p>',

    //Sobre - EN
    '<p>The 19th Contemporary Art Festival Sesc_Videobrasil offers a Grand Prize to one of the artists selected from this edition’s artworks call for entries, chosen by the <a class="link" onclick="location.href = \'http://19festival.com/premios_e_residencias.php#juri\';">Award Jury</a>.</p>');  ?> 
    </div> 
</div>         
