...
<script>
        $(document).ready(
            function(){
                ...
                $('#pub-fest-3').click(function(){
                   window.open('http://www.sescsp.org.br/livraria/3659_PANORAMAS+DO+SUL+OBRAS+SELECIONADAS+E+PROJETOS+COMISSIONADOS#/content=detalhes-do-produto', '_blank');
                })
            ...
            <div class="row" style="clear: both;">     
                ...
                *em ocasião da 2ª mesa do seminário <em><a href="/pp.php#seminario" class="link">LUGARES E SENTIDOS DA ARTE: Tradições, Espaços, Tempos e Narrativas ao Sul</a></em></p>',
                ...
                <br /><p><span class="bold upper">Launch</span> | OCT/10 (sat) | 4:30pm | Sesc Pompeia | Theater<br />
            ...
            <div class="row" style="clear: both;">     
                ...
                <p style="display: inline"><span class="upper">DESIGN</span> Carla Castilho, Lia Assumpção | Janela Estúdio</p><br />
                <!-- <p style="text-align: right; font-size: 1.1em" class="bold upper">Learn more</p><br /> -->
                <br /><p><span class="bold upper">Launch</span> | OCT/10 (sat) | 4:30pm | Sesc Pompeia | Theater\'s foyer</p>');  ?> 
                </div> 
            </div>
                ...
                <div class="col-xs-12" style="float: left; margin-bottom: 28px">
                    <p style="margin-bottom:0"> 
                        <a name="visita"></a><?php pten(
                            ...
                            '<span class="titulo">SOUTHERN PANORAMAS | SELECTED ARTISTS – ARTWORKS AND commissioned PROJECTS</span>'); ?>
                    </p>
                </div>
            </div>
            ...
            <div class="row" style="clear: both;">     
                <div class="col-sm-12 col-md-6 pp-participantes" style="float: left ">
                    ...
                    <p><input type="button" id="pub-fest-3" value="<?php pten('comprar', 'purchase'); ?>" /></p>
