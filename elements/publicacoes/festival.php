                ...
                <div class="col-xs-12" style="float: left; margin-bottom: 28px">
                    <p style="margin-bottom:0"> 
                        <a name="visita"></a><?php pten(
                            '<span class="titulo n">Videobrasil: Três Décadas De Vídeo, Arte, Encontros E Transformações</span>',

                             '<span class="titulo n">VIDEOBRASIL: THREE DECADES OF VIDEO, ART, ENCOUNTERS AND TRANSFORMATIONS</span>'); ?>
                    </p>
                </div>
            </div>
