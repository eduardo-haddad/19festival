...
<!-- PROGRAMA 1 -->
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 f" style="float: right;">
                <p><span class="bold"><?php pten('Slinko (Ucrânia / EUA)', 'Slinko (Ukraine / USA)'); ?><br />
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 f" style="float: right;">
                <p><span class="bold"><?php pten('Karolina Bregula (Polônia)', 'Karolina Bregula (Poland)'); ?><br />
        ...
        <div class="row" style="clear: both;">
            ...
            <div class="col-sm-12 col-md-6 f" style="float: right;">
                <p><span class="bold"><?php pten('Tatiana Fuentes Sadowski (Peru/França)', 'Tatiana Fuentes Sadowski (Peru/France)'); ?><br />
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 f" style="float: right;">
                <p><span class="bold"><?php pten('Ali Cherri (Líbano)', 'Ali Cherri (Lebanon)'); ?><br />
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 f" style="float: right;">
                <p><span class="bold"><?php pten('Kush Badhwar (Índia/Austrália)', 'Kush Badhwar (India/Australia)'); ?><br />
        ...
        <div class="row" style="clear: both;">
            ...
            <div class="col-sm-12 col-md-6 f" style="float: right;">
                <p><span class="bold"><?php pten('Viktorija Rybakova (Lituânia/México)', 'Viktorija Rybakova (Lithuania/Mexico)'); ?><br />
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 f" style="float: right;">
                <p><span class="bold"><?php pten('Ana Vaz (Brasil/França)', 'Ana Vaz (Brasil/France )'); ?><br />
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 f" style="float: right;">
                <p><span class="bold"><?php pten('Chulayarnnon Siriphol (Tailândia)', 'Chulayarnnon Siriphol (Thailand)'); ?><br />
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 f" style="float: right;">
                <p><span class="bold"><?php pten('Distruktur (Brasil/Alemanha)', 'Distruktur (Brazil/Germany)'); ?><br />
                   In the Traveler's Heart [No coração do viajante], 2013, 19’</span><br />
                   <?php pten('A maior parte da obra do Distruktur constitui-se em filmes em Super-8 e 16 mm, definidos pela dupla de artistas como filmes-performances, num trânsito constante entre os campos do cinema e das artes visuais. In the Traveler’s Heart fala do trajeto de um sujeito solitário, duplo de homem e mulher, que caminha entre a neve e o mar. O barulho de seus passos é interrompido quando o canto do viajante faz ecoar Cuitelinho, música do cancioneiro popular brasileiro que fala de uma saudade cortante como aço de navalha.',
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 f" style="float: right;">
                <p><span class="bold"><?php pten('Letícia Ramos (Brasil)', 'Letícia Ramos (Brasil)'); ?><br />
