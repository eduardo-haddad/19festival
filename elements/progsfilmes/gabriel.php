...
<!-- PROGRAMA 1 -->
        ...
        <div class="row" style="clear: both;"> <!--  </div> no fim do documento para unir sinopses-->
            ...
            <div class="col-sm-12 col-md-6 f" style="float: right;">
                <p><span class="bold">
                <?php pten('<a href="/gabrielabrantes" id="linkartista">Gabriel Abrantes</a> e Katie Widloski', '<a href="/gabrielabrantes" id="linkartista">Gabriel Abrantes</a> & Katie Widloski'); ?><br />
                Olympia I & II, 2006, 9’</span><br />
                <?php pten('O filme é um díptico, com duas reconstituições de <em>Olympia</em>, famoso quadro de Édouard Manet. O primeiro tableau mostra Katie como Olympia; o segundo mostra Abrantes em uma versão masculina do personagem. Realizado com filme 16 mm, o que enfatiza suas qualidades pictóricas, <em>Olympia</em> desconstrói a aura mítica do quadro de Manet, ao mesmo tempo em que complexifica seu legado.',
