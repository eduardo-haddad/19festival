...
<!-- EVENTO 1 -->
            ...
            <div class="row" style="clear: both;">     
                ...
                pten('<p>O artista malinês Abdoulaye Konaté conduz uma oficina de monotipia. A partir da prática do ateliê coletivo, o artista aproxima o público de sua poética e de linguagens artísticas tradicionais do Mali, seu local de origem.
                    ...
                    <p><span class="bold">Para participar</span> é preciso ter mais de 11 anos. Inscrições gratuitas, no local, a partir do dia 3.10. <span class="bold">Vagas limitadas.</span>
                    </p>',
                ...
                <p><span class="bold">How to participate</span> participants must be 11 or older. Registration is free and will be available onsite from Oct 3. <span class="bold">Seats are limited</span>.</p>
                ');  ?> 
                </div> 
            </div>
            ...
            <div class="row" style="clear: both;">     
                ...
                pten('<p>A partir do trabalho da artista Ting-Ting Cheng, que apresenta uma biblioteca sobre lugares inexistentes na exposição Panoramas do Sul | Projetos comissionados, o público explora livros, histórias e imagens para construir, coletivamente, um repertório conceitual e imagético em torno da ideia de um lugar do Sul. 
                    ...
                    <p><span class="bold">Para participar</span> é preciso ter mais de 15 anos e inglês avançado. Inscrições gratuitas, a partir de 3.10, na Convivência Sesc Pompeia, com os mediadores da exposição. <span class="bold">Vagas limitadas.</span>
                    </p>',
                ...
                <p><span class="bold">How to participate</span> participants must be 15 or older; advanced English skills required. Registration is free and begins on Oct 3 at Sesc Pompeia’s Convivência area, with the exhibition’s mediators. <span class="bold">Seats are limited</span>.</p>
                ');  ?> 
                </div> 
            </div>
            ...
            <div class="row" style="clear: both;">     
                ...
                pten('<p>O artista Carlos Monroy propõe uma vivência que evoca elementos de memória e construção familiar a partir do corpo. A oficina gera reflexões sobre origem, mestiçagem cultural e construção folclórica, e termina em uma prática de dança.  
                    ...
                    <p><span class="bold">Para participar</span> é preciso ter mais de 15 anos. Inscrições gratuitas, na Convivência Sesc Pompeia ou no Galpão VB (com os mediadores da exposição), ou pelo email <a href="mailto:portfolio@zebra5.com.br" class="link">portfolio@zebra5.com.br</a>. <span class="bold">Vagas limitadas.</span>
                    </p>',
                ...
                <p><span class="bold">How to participate</span> participants must be 15 or older. Registration is free, at Sesc Pompeia’s Convivência area or at Galpão VB (with the exhibition’s mediators), or by sending an email to <a href="mailto:portfolio@zebra5.com.br" class="link">portfolio@zebra5.com.br</a>. <span class="bold">Seats are limited</span>.</p>
                ');  ?> 
                </div> 
            </div>
