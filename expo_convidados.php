                ...
                <div class="col-sm-12 col-md-6 relative" >
                    ...
                    <div id="lista" style="margin-bottom: 19px">
                        <ol>
                            ...
                            <li>Abdoulaye Konaté | <?php pten('Mali', 'Mali'); ?></li>
                            <li>Gabriel Abrantes | <?php pten('Portugal', 'Portugal'); ?></li>
                            <li>Rodrigo Matheus | <?php pten('Brasil', 'Brazil'); ?></li>
                            <li>Sônia Gomes | <?php pten('Brasil', 'Brazil'); ?></li>
                            <li>Yto Barrada | <?php pten('Marrocos/França', 'Morocco/France'); ?></li>
                        </ol>
                    </div>
                </div>
