        ...
        <!-- /HEADER -->
        	...
        	<div class="row">
        		<div class="col-xs-12 breadcrumb">
                    <span><?php pten('<a href="index.php#exposicoes" class="link">exposições</a> > <span class="underline">obras selecionadas</span>', 
                                     '<a href="index.php#exposicoes" class="link">exhibitions</a> > <span class="underline">selected works</span>');  ?></span>      
                </div>
        	</div>
            ...
            <div class="row" style="clear: both;">
                ...
                <div class="col-sm-12 col-md-6 relative" >
                    <img src="img/expos/expo-obras-img.jpg" class="img-responsive" style="max-width: 485px" />
                    <div id="lista">
                        <ol>
