...
ommissioned projects');?></a> | 
                    ...
                    <div id="texto7a" class="texto" style="display:none;">
                        ...
                        <p class="nomargin texto-submenu r"><?php pten(
                            'O <span class="bold">19º Festival de Arte Contemporânea Sesc_Videobrasil | Panoramas do Sul</span> amplia seu número de premiações. Além do Grande Prêmio em dinheiro e de nove prêmios de residência, o 19º Festival lança um prêmio especial: o Prêmio SP-Arte/Videobrasil. Concorrem à premiação os 53 artistas selecionados pelo edital de obras que participam de exposição e programas de filmes no Sesc Pompeia e no Galpão VB, em São Paulo, Brasil, de 6 de outubro a 6 de dezembro de 2015. Os artistas premiados serão anunciados no dia <span class="bold">10 de outubro</span>, em cerimônia no Teatro do Sesc Pompeia, às 18h.',
