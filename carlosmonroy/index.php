        ...
        <div style="height:36px; clear: both">&nbsp;</div>
            ...
            <div class="row" id="obra">
                <div class="col-sm-12 col-md-6" style="text-align: center;" id="obra-img">
                    ...
                    <img src="../img/projetos/monroy_2.jpg" class="img-responsive" style="margin-bottom: 15px;" />
                    <img src="../img/projetos/monroy_1.jpg" class="img-responsive" style="margin-bottom: 15px;" />
                </div>
