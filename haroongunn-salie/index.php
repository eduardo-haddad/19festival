...
$urlplataforma = '#sundaybest';

include_once($_SERVER['DOCUMENT_ROOT'] . "/elements/config.php");

$pais_artista = $idioma == 'pt' ?  'África do Sul' : 'South Africa';
    ...
    <main class="container" id="container">
        ...
        <div style="height:36px; clear: both">&nbsp;</div>
            ...
            <div class="row" >
                ...
                <?php pten('Artista contemplado com o <a href="/premios_e_residencias.php#especial" class="link">PRÊMIO SP-ARTE/VIDEOBRASIL</a>', 
                           'Artist awarded with the <a href="/premios_e_residencias.php#especial" class="link">SP-ARTE/VIDEOBRASIL PRIZE</a>'); ?>
                </span>
