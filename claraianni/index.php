    ...
    <main class="container" id="container">
        ...
        <div style="height:36px; clear: both">&nbsp;</div>
            ...
            <div class="row" >
                ...
                <?php pten('Artista contemplada com o <a href="/premios_e_residencias.php#premios" class="link">PRÊMIO DE RESIDÊNCIA A-I-R LABORATORY</a> (Varsóvia, Polônia)', 
                           'Artist awarded with the <a href="/premios_e_residencias.php#premios" class="link">A-I-R LABORATORY residency prize</a> (Warsaw, Poland)'); ?>
                </span>
