        ...
        <!-- /HEADER -->
        	...
        	<div class="row">
        		<div class="col-xs-12 breadcrumb">
                    <span>sobre o festival > comissão curadora</span>      
                </div>
        	</div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 u" style="float: right;">
                    <p style="margin-bottom: 0"><strong>Solange Farkas</strong> (vive e trabalha em São Paulo, Brasil)
