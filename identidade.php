        ...
        <!-- /HEADER -->
        	...
        	<div class="row">
        		<div class="col-xs-12 breadcrumb">
                    <span><?php pten('sobre o festival > <span class="underline">identidade visual</span>', 
                                     'about the festival > <span class="underline">visual identity</span>');  ?></span>      
                </div>
        	</div>
            ...
            <div class="row" style="clear: both;">
                ...
                <div class="col-sm-12 col-md-6 relative" id="id-imagem-bottom">
                    <img src="img/artistas/anavaz.jpg" id="img-id-1" class="img-responsive" />
