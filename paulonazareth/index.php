    ...
    <main class="container" id="container">
        ...
        <div style="height:36px; clear: both">&nbsp;</div>
            ...
            <div class="row" >
                ...
                <?php pten('Artista contemplado com o <a href="/premios_e_residencias.php#premios" class="link">Prêmio de Residência Arquetopia_Videobrasil</a> na Arquetopia (Puebla, México)', 
                           'Artist awarded with the <a href="/premios_e_residencias.php#premios" class="link">Arquetopia_Videobrasil Residency Prize</a> at Arquetopia (Puebla, Mexico)'); ?>
                </span>
