...
$urlplataforma = '#escenarios';

include_once($_SERVER['DOCUMENT_ROOT'] . "/elements/config.php");

$pais_artista = $idioma == 'pt' ?  'Peru / Países Baixos' : 'Peru / Netherlands';
    ...
    <main class="container" id="container">
        ...
        <div style="height:36px; clear: both">&nbsp;</div>
            ...
            <div class="row" >
                ...
                <?php pten('Artista contemplada com o <a href="/premios_e_residencias.php#premios" class="link">PRÊMIO DE RESIDÊNCIA RES ARTIS</a> no Kyoto Art Center (Kyoto, Japão)', 
                           'Artist awarded with the <a href="/premios_e_residencias.php#premios" class="link">RES ARTIS residency prize</a> at Kyoto Art Center (Kyoto, Japan)'); ?>
                </span>
